...
public class AvroBinaryMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AvroBinaryMessage(java.lang.Long sequence, io.mercury.codec.avro.structure.Envelope envelope, java.nio.ByteBuffer content) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: envelope = (io.mercury.codec.avro.structure.Envelope)value$; break;
   ...
   * @return A new AvroBinaryMessage RecordBuilder
   */
  public static io.mercury.codec.avro.structure.AvroBinaryMessage.Builder newBuilder(io.mercury.codec.avro.structure.AvroBinaryMessage.Builder other) {
    if (other == null) {
      return new io.mercury.codec.avro.structure.AvroBinaryMessage.Builder();
    } else {
   ...
   * @return A new AvroBinaryMessage RecordBuilder
   */
  public static io.mercury.codec.avro.structure.AvroBinaryMessage.Builder newBuilder(io.mercury.codec.avro.structure.AvroBinaryMessage other) {
    if (other == null) {
      return new io.mercury.codec.avro.structure.AvroBinaryMessage.Builder();
    } else {
      return new io.mercury.codec.avro.structure.AvroBinaryMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroBinaryMessage>
    ...
    /**
      ...
      * @return This builder.
      */
    public io.mercury.codec.avro.structure.AvroBinaryMessage.Builder setEnvelope(io.mercury.codec.avro.structure.Envelope value) {
     ...
     * @return This builder.
     */
    public io.mercury.codec.avro.structure.AvroBinaryMessage.Builder setEnvelopeBuilder(io.mercury.codec.avro.structure.Envelope.Builder value) {
      clearEnvelope();
    ...
    public AvroBinaryMessage build() {
      try {
        ...
        if (envelopeBuilder != null) {
          ...
          record.envelope = fieldSetFlags()[1] ? this.envelope : (io.mercury.codec.avro.structure.Envelope) defaultValue(fields()[1]);
        }
