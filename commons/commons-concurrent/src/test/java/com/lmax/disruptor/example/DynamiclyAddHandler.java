...
public class DynamiclyAddHandler {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Disruptor<StubEvent> disruptor = new Disruptor<>(StubEvent.EVENT_FACTORY, 1024,
        ...
        BatchEventProcessor<StubEvent> processor1 = new BatchEventProcessor<>(ringBuffer,
                ringBuffer.newBarrier(), handler1);

        DynamicHandler handler2 = new DynamicHandler();
        BatchEventProcessor<StubEvent> processor2 = new BatchEventProcessor<>(ringBuffer,
