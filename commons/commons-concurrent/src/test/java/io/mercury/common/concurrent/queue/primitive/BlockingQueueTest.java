...
public abstract class BlockingQueueTest extends JSR166TestCase {
	...
	/*
	 * This is the start of an attempt to refactor the tests for the various related
	 * implementations of related interfaces without too much duplicated code. junit
	 * does not really support such testing. Here subclasses of TestCase not only
	 * contain tests, but also configuration information that describes the
	 * implementation class, most importantly how to instantiate instances.
	 */
