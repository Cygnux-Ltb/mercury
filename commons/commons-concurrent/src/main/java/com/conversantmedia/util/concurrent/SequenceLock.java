...
/**
 * <a href="http://www.hpl.hp.com/techreports/2012/HPL-2012-68.pdf">HPL-2012-68</a>
 */
public class SequenceLock implements OptimisticLock {

    private final ContendedAtomicLong sequence = new ContendedAtomicLong(2);
    ...
    public boolean readLockHeld(final long lockToken) {
        return sequence.get() == lockToken && (lockToken & 1) == 0;
    }
