...
public interface BlockingStack<N> extends Stack<N> {
	...
	/**
	 * Push an element on the stack waiting as long as required for space to become
	 * available
	 *
	 * @param n - the element to push
	 * @throws InterruptedException - in the event the current thread is interrupted
	 *                              prior to pushing the element
	 */
	...
	/**
	 * Pop an element from the stack, waiting as long as required for an element to
	 * become available on the stack
	 *
	 * @return N - the popped element
	 * @throws InterruptedException - in the event the current thread is interrupted
	 *                              prior to popping any element
	 */
