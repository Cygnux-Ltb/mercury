...
/**
 * This is the disruptor implemented for multiple simultaneous reader and writer
 * threads.
 *
...
public class MultithreadConcurrentQueue<E> implements ConcurrentQueue<E> {
	/*
	 * Note to future developers/maintainers - This code is highly tuned and
	 * possibly non-intuitive. Rigorous performance and functional testing should
	 * accompany any proposed change
	 *
	 */
