 ...
 * create non-blocking code with guaranteed writes. This writes will not be
 * re-ordered by instruction reordering. Under the covers it uses the faster
 * store-store barrier, rather than the slower store-load barrier, which is
 ...
 * <td>{@link #offer(byte, long, TimeUnit) offer(e, time,
 * unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
...
public final class ConcurrentByteQueue extends AbstractConcurrentQueue {
     ...
     * elements being in neither, either nor both collections when the associated
