 ...
 * long[]. This class mimics the interface of
 * {@linkplain java.util.concurrent.BlockingQueue BlockingQueue}, however works
 * with primitive longs rather than {@link Object}s, so is unable to actually
 ...
 * <td>{@link #offer(long, long, java.util.concurrent.TimeUnit) offer(e, time,
 * unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <p>
 * <p>
 * A <tt>uk.co.boundedbuffer.ConcurrentBlockingLongQueue</tt> is capacity
 ...
 * <p>
 * <p>
 * All of <tt>uk.co.boundedbuffer.ConcurrentBlockingLongQueue</tt> methods are
 ...
 * uk.co.boundedbuffer.ConcurrentBlockingLongQueue does <em>not</em>
...
@ThreadSafe
public final class ConcurrentLongQueue extends AbstractConcurrentQueue {
	 ...
	 */
	public ConcurrentLongQueue(int capacity) {
		super(capacity);
	}
	 ...
	 * preferable to use {@link #offer(long) offer}.
	 *
	...
	public long peek(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 * @throws java.util.concurrent.TimeoutException if timeout time is exceeded
	 */
	public long poll(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 * operation {@link #take()}. {@link #offer(long)}, {@link #put(long)},
	 * {@link #drainTo(long[], int)}}
	 *
