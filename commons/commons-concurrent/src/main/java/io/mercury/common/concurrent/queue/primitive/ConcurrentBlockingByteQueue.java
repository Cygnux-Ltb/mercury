 ...
 * with primitive bytes rather than {@link Object}s, so is unable to actually
 ...
 * <td>{@link #offer(byte, long, java.util.concurrent.TimeUnit) offer(e, time,
 * unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <p>
 * <p>
 * A <tt>uk.co.boundedbuffer.ConcurrentBlockingByteQueue</tt> is capacity
 ...
 * <p>
 * <p>
 * All of <tt>uk.co.boundedbuffer.ConcurrentBlockingByteQueue</tt> methods are
 ...
 * uk.co.boundedbuffer.ConcurrentBlockingByteQueue does <em>not</em>
 ...
 * @since 1.1
 */
public class ConcurrentBlockingByteQueue extends BaseConcurrentBlockingQueue {
	 ...
	 * preferable to use {@link #offer(byte) offer}.
	 *
	...
	public byte peek(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 *                                  prevents it from being added to this queue
	 */
	public boolean offer(byte value, long timeout, TimeUnit unit) throws InterruptedException {
	 ...
	 * @throws java.util.concurrent.TimeoutException if timeout time is exceeded
	 */
	public byte poll(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 * {@link #take()}. {@link #offer(byte)}, {@link #put(byte)},
	 * {@link #drainTo(byte[], int)}}
	 *
	...
	int drainTo(byte[] target, int maxElements) {
		...
		// we want to minimize the number of volatile reads, so we read the readLocation
		// just once.
		int readLocation = this.readLocation;
