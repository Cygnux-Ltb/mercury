 ...
 * {@linkplain java.util.concurrent.BlockingQueue BlockingQueue},
 * <p>
 * This class takes advantage of the Unsafe.putOrderedObject, which allows us to
 ...
 * <td>{@link #offer(E, long, java.util.concurrent.TimeUnit) offer(e, time,
 * unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <p>
 * <p>
 * A <tt>uk.co.boundedbuffer.ConcurrentBlockingEQueue</tt> is capacity bounded.
 * At any given time it may have a <tt>remainingCapacity</tt> beyond which no
 ...
 * <p>
 * <p>
 * All of <tt>uk.co.boundedbuffer.ConcurrentBlockingEQueue</tt> methods are
 ...
 * uk.co.boundedbuffer.ConcurrentBlockingEQueue does <em>not</em> intrinsically
 * support any kind of &quot;close&quot; or &quot;shutdown&quot; operation to
 * indicate that no more items will be added. The needs and usage of such
 * features tend to be implementation-dependent. For example, a common tactic is
 * for producers to insert special <em>end-of-stream</em> or <em>poison</em>
...
public final class ConcurrentBlockingQueue<E> extends BaseConcurrentBlockingQueue implements BlockingQueue<E> {
	...
	public E peek(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	...
	public E poll() {
		...
		// purposely not volatile as the read memory barrier occurred when we read
		// 'writeLocation'
		final E value = data[readLocation];
		setReadLocation(nextReadLocation);
	 ...
	 * operation {@link #take()}. {@link #offer(E)}, {@link #put(E)},
	 * {@link #drainTo(E[], int)}}
	 *
