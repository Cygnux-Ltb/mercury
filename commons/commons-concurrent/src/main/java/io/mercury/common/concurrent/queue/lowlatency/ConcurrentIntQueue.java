 ...
 * int[]. This class mimics the interface of
 * {@linkplain java.util.concurrent.BlockingQueue BlockingQueue}, however works
 * with primitive ints rather than {@link Object}s, so is unable to actually
 ...
 * <td>{@link #offer(int, long, java.util.concurrent.TimeUnit) offer(e, time,
 * unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <p>
 * <p>
 * A <tt>uk.co.boundedbuffer.ConcurrentBlockingIntQueue</tt> is capacity
 ...
 * <p>
 * <p>
 * All of <tt>uk.co.boundedbuffer.ConcurrentBlockingIntQueue</tt> methods are
 ...
 * uk.co.boundedbuffer.ConcurrentBlockingIntQueue does <em>not</em>
...
@ThreadSafe
public final class ConcurrentIntQueue extends AbstractConcurrentQueue {
	 ...
	 * preferable to use {@link #offer(int) offer}.
	 *
	 ...
	 * @throws java.util.concurrent.TimeoutException if timeout time is exceeded
	 */
	public int poll(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 * {@link #take()}. {@link #offer(int)}, {@link #put(int)},
	 * {@link #drainTo(int[], int)}}
	 *
