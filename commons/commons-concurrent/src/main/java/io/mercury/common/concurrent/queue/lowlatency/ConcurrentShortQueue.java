 ...
 * short[]. This class mimics the interface of
 * {@linkplain java.util.concurrent.BlockingQueue BlockingQueue}, however works
 * with primitive shorts rather than {@link Object}s, so is unable to actually
 ...
 * <td>{@link #offer(short, long, java.util.concurrent.TimeUnit) offer(e, time,
 * unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <p>
 * <p>
 * A <tt>uk.co.boundedbuffer.ConcurrentBlockingShortQueue</tt> is capacity
 ...
 * <p>
 * <p>
 * All of <tt>uk.co.boundedbuffer.ConcurrentBlockingShortQueue</tt> methods are
 ...
 * uk.co.boundedbuffer.ConcurrentBlockingShortQueue does <em>not</em>
...
@ThreadSafe
public final class ConcurrentShortQueue extends AbstractConcurrentQueue {
	 ...
	 */
	public ConcurrentShortQueue(int capacity) {
		super(capacity);
	}
	 ...
	 * preferable to use {@link #offer(short) offer}.
	 *
	...
	public short peek(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 * @throws InterruptedException if interrupted while waiting
	 */
	public boolean offer(short value, long timeout, TimeUnit unit) throws InterruptedException {
	 ...
	 * @throws java.util.concurrent.TimeoutException if timeout time is exceeded
	 */
	public short poll(long timeout, TimeUnit unit) throws InterruptedException, TimeoutException {
	 ...
	 * operation {@link #take()}. {@link #offer(short)}, {@link #put(short)},
	 * {@link #drainTo(short[], int)}}
	 *
