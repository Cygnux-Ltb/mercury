...
public class FileCompressionUtil {
     ...
     * @throws IOException Thrown if an error occurs while attempting to compress
     *                     the source file.
     */
     ...
     * @throws IOException Thrown if an error occurs while attempting to uncompress
     *                     the source file.
     */
     ...
     * IOException { // FIXME: VERY SIMPLE IMPL -- LIKELY SHOULD TRY TO EMULATE THIS
     * BETTER // by pulling code from its main try {
     *
     * // compress using LZMA LzmaAlone.main(new String[]{"e",
     * srcFile.getCanonicalPath(), destFile.getCanonicalPath()}); } catch (Exception
     * ex) { logger.error("", ex); throw new IOException("LZMA compression failed: "
     * + ex.getMessage()); } }
     *
     * @Override public void uncompress(File srcFile, File destFile) throws
     * IOException { throw new UnsupportedOperationException("LZMA uncompress not
     * supported yet."); }
     *
     * @Override public void uncompress(InputStream srcIn, OutputStream destOut)
     * throws IOException { throw new UnsupportedOperationException("LZMA uncompress
     * not supported yet."); }
     *
     * @Override public void compress(InputStream srcIn, OutputStream destOut)
     * throws IOException { throw new UnsupportedOperationException("Not supported
     * yet."); }
     *
     * }
     */
