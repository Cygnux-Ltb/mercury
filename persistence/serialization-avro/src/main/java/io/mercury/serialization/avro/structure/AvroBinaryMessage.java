...
public class AvroBinaryMessage extends org.apache.avro.specific.SpecificRecordBase
	...
	private static final BinaryMessageEncoder<AvroBinaryMessage> ENCODER = new BinaryMessageEncoder<AvroBinaryMessage>(
			MODEL$, SCHEMA$);

	private static final BinaryMessageDecoder<AvroBinaryMessage> DECODER = new BinaryMessageDecoder<AvroBinaryMessage>(
			MODEL$, SCHEMA$);
	 ...
	 */
	public static AvroBinaryMessage fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
	 ...
	 */
	public AvroBinaryMessage(java.lang.Long sequence, io.mercury.serialization.avro.structure.Envelope envelope,
	...
	public void put(int field$, java.lang.Object value$) {
		...
		case 0:
			...
			break;
		case 1:
			envelope = (io.mercury.serialization.avro.structure.Envelope) value$;
			break;
		case 2:
	 ...
	 */
	public static io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder newBuilder(
			io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder other) {
		if (other == null) {
			return new io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder();
		} else {
	...
	/**
	 * Creates a new AvroBinaryMessage RecordBuilder by copying an existing
	 * AvroBinaryMessage instance.
	 * 
	 * @param other The existing instance to copy.
	 * @return A new AvroBinaryMessage RecordBuilder
	 */
	public static io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder newBuilder(
			io.mercury.serialization.avro.structure.AvroBinaryMessage other) {
		if (other == null) {
			return new io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder();
		} else {
			return new io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroBinaryMessage>
		...
		private Builder(io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder other) {
			...
			if (other.hasEnvelopeBuilder()) {
				this.envelopeBuilder = io.mercury.serialization.avro.structure.Envelope
		 ...
		 * @return This builder.
		 */
		public io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder setEnvelope(
				io.mercury.serialization.avro.structure.Envelope value) {
		 ...
		 * @return This builder.
		 */
		public io.mercury.serialization.avro.structure.AvroBinaryMessage.Builder setEnvelopeBuilder(
				io.mercury.serialization.avro.structure.Envelope.Builder value) {
			clearEnvelope();
			...
			try {
				...
				if (envelopeBuilder != null) {
					...
					record.envelope = fieldSetFlags()[1] ? this.envelope
							: (io.mercury.serialization.avro.structure.Envelope) defaultValue(fields()[1]);
				}
	...
	private static final org.apache.avro.io.DatumWriter<AvroBinaryMessage> WRITER$ = (org.apache.avro.io.DatumWriter<AvroBinaryMessage>) MODEL$
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumReader<AvroBinaryMessage> READER$ = (org.apache.avro.io.DatumReader<AvroBinaryMessage>) MODEL$
