...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    /**
     * Deserializes an Envelope from a ByteBuffer.
     *
     * @param b a byte buffer holding serialized data for an instance of this class
     * @return an Envelope instance decoded from the given buffer
     ...
     */
    public Envelope(java.lang.Integer code, java.lang.Integer version, io.mercury.serialization.avro.msg.ContentType contentType) {
        this.code = code;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0 -> code = (Integer) value$;
            case 1 -> version = (Integer) value$;
            case 2 -> contentType = (ContentType) value$;
            default -> throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
    }
     ...
     */
    public Envelope setCode(int value) {
        this.code = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public Envelope setVersion(int value) {
        this.version = value;
        return this;
    }
     ...
     * @param value the value to set.
     */
    public Envelope setContentType(io.mercury.serialization.avro.msg.ContentType value) {
     ...
     * @return A new Envelope RecordBuilder
     */
    public static io.mercury.serialization.avro.msg.Envelope.Builder newBuilder(io.mercury.serialization.avro.msg.Envelope.Builder other) {
        if (other == null) {
            return new io.mercury.serialization.avro.msg.Envelope.Builder();
        } else {
     ...
     * @return A new Envelope RecordBuilder
     */
    public static io.mercury.serialization.avro.msg.Envelope.Builder newBuilder(io.mercury.serialization.avro.msg.Envelope other) {
        if (other == null) {
            return new io.mercury.serialization.avro.msg.Envelope.Builder();
        } else {
            return new io.mercury.serialization.avro.msg.Envelope.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
         ...
         * @return This builder.
         */
        public io.mercury.serialization.avro.msg.Envelope.Builder setContentType(io.mercury.serialization.avro.msg.ContentType value) {
        ...
        public Envelope build() {
            try {
                ...
                record.contentType = fieldSetFlags()[2] ? this.contentType : (io.mercury.serialization.avro.msg.ContentType) defaultValue(fields()[2]);
                return record;
        ...
        if (fieldOrder == null) {
            ...
            for (int i = 0; i < 3; i++) {
                switch (fieldOrder[i].pos()) {
                    case 0 -> this.code = in.readInt();
                    case 1 -> this.version = in.readInt();
                    case 2 -> this.contentType = ContentType.values()[in.readEnum()];
