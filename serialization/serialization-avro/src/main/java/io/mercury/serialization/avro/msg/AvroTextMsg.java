...
public class AvroTextMsg extends org.apache.avro.specific.SpecificRecordBase
	...
	private static final BinaryMessageDecoder<AvroTextMsg> DECODER = new BinaryMessageDecoder<AvroTextMsg>(MODEL$,
			SCHEMA$);
	 ...
	 */
	public static AvroTextMsg fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
	 ...
	 */
	public static io.mercury.serialization.avro.msg.AvroTextMsg.Builder newBuilder(
			io.mercury.serialization.avro.msg.AvroTextMsg.Builder other) {
		if (other == null) {
			return new io.mercury.serialization.avro.msg.AvroTextMsg.Builder();
		} else {
	...
	/**
	 * Creates a new AvroTextMsg RecordBuilder by copying an existing AvroTextMsg
	 * instance.
	 * 
	 ...
	 */
	public static io.mercury.serialization.avro.msg.AvroTextMsg.Builder newBuilder(
			io.mercury.serialization.avro.msg.AvroTextMsg other) {
		if (other == null) {
			return new io.mercury.serialization.avro.msg.AvroTextMsg.Builder();
		} else {
			return new io.mercury.serialization.avro.msg.AvroTextMsg.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroTextMsg>
		...
		public io.mercury.serialization.avro.msg.AvroTextMsg.Builder setEnvelopeBuilder(
	...
	private static final org.apache.avro.io.DatumWriter<AvroTextMsg> WRITER$ = (org.apache.avro.io.DatumWriter<AvroTextMsg>) MODEL$
	...
	@SuppressWarnings("unchecked")
	private static final org.apache.avro.io.DatumReader<AvroTextMsg> READER$ = (org.apache.avro.io.DatumReader<AvroTextMsg>) MODEL$
