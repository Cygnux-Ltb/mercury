...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7004257321388444386L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"io.mercury.serialization.avro.structure\",\"fields\":[{\"name\":\"version\",\"type\":\"int\"},{\"name\":\"type\",\"type\":\"int\"},{\"name\":\"contentType\",\"type\":{\"type\":\"enum\",\"name\":\"ContentType\",\"symbols\":[\"OBJECT\",\"LIST\",\"STRING\",\"INT\",\"LONG\",\"DOUBLE\"]}}]}");
  ...
  /**
   * Gets the value of the 'contentType' field as an Optional&lt;io.mercury.serialization.avro.structure.ContentType&gt;.
   * @return The value wrapped in an Optional&lt;io.mercury.serialization.avro.structure.ContentType&gt;.
   */
