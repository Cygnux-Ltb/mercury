...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase
	...
	public Envelope(java.lang.Integer version, java.lang.Integer type,
			io.mercury.serialization.avro.structure.ContentType contentType) {
	 ...
	 */
	public static io.mercury.serialization.avro.structure.Envelope.Builder newBuilder(
			io.mercury.serialization.avro.structure.Envelope.Builder other) {
		if (other == null) {
			return new io.mercury.serialization.avro.structure.Envelope.Builder();
		} else {
	 ...
	 */
	public static io.mercury.serialization.avro.structure.Envelope.Builder newBuilder(
			io.mercury.serialization.avro.structure.Envelope other) {
		if (other == null) {
			return new io.mercury.serialization.avro.structure.Envelope.Builder();
		} else {
			return new io.mercury.serialization.avro.structure.Envelope.Builder(other);
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
		 ...
		 * @return This builder.
		 */
		public io.mercury.serialization.avro.structure.Envelope.Builder setContentType(
				io.mercury.serialization.avro.structure.ContentType value) {
		...
		public Envelope build() {
			try {
				...
				record.contentType = fieldSetFlags()[2] ? this.contentType
						: (io.mercury.serialization.avro.structure.ContentType) defaultValue(fields()[2]);
				return record;
