...
/**
 * A light-weight extension of {@link SpecificDatumReader} which merely ensures
 * that the types of the extended API are always returned.
 *
 * This class needs to be in the org.apache.avro.generic package in order to
