...
public class OtfExample {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        @SuppressWarnings("unused") final int schemaId = headerDecoder.getSchemaId(buffer, bufferOffset);
        ...
        // Given the header information we can select the appropriate message template
        // to do the decode operation.
        // The OTF Java classes are thread safe so the same instances can be reused
