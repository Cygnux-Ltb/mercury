...
public class WireCollection extends WireModel implements Marshallable {
    ...
    public void readMarshallable(@NotNull WireIn wire) throws IllegalStateException {
        ...
        this.properties = wire.read(WireCollection.Values.PROPERTIES).marshallableAsMap(String.class,
                WireProperty.class);
        this.collections = wire.read(WireCollection.Values.COLLECTIONS).marshallableAsMap(String.class,
    ...
    public void writeMarshallable(@Nonnull WireOut wire) {
        ...
        if (collections.size() > 0) {
            wire.write(WireCollection.Values.COLLECTIONS).marshallable(collections);
        }
    }
