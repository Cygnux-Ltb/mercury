...
public class AvroMsg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2884863883826810699L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroMsg\",\"namespace\":\"io.mercury.actors.messages\",\"fields\":[{\"name\":\"msgType\",\"type\":\"int\"},{\"name\":\"msgContent\",\"type\":\"bytes\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AvroMsg> ENCODER =
      new BinaryMessageEncoder<AvroMsg>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AvroMsg> DECODER =
      new BinaryMessageDecoder<AvroMsg>(MODEL$, SCHEMA$);
   ...
   */
  public static AvroMsg fromByteBuffer(
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: msgType = (java.lang.Integer)value$; break;
    case 1: msgContent = (java.nio.ByteBuffer)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new AvroMsg RecordBuilder
   */
  public static io.mercury.actors.messages.AvroMsg.Builder newBuilder(io.mercury.actors.messages.AvroMsg.Builder other) {
    if (other == null) {
      return new io.mercury.actors.messages.AvroMsg.Builder();
    } else {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroMsg>
    ...
    public AvroMsg build() {
      try {
        ...
        record.msgContent = fieldSetFlags()[1] ? this.msgContent : (java.nio.ByteBuffer) defaultValue(fields()[1]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AvroMsg>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvroMsg>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvroMsg>
    READER$ = (org.apache.avro.io.DatumReader<AvroMsg>)MODEL$.createDatumReader(SCHEMA$);
