...
//  Binary Star server, using BinaryStarReactor
public class BinaryStarServer2 {
	...
	public static void main(String[] argv) {
		...
		if (argv.length == 1 && argv[0].equals("-p")) {
			...
			bs = new BinaryStarReactor(false, "tcp://*:5004", "tcp://localhost:5003");
