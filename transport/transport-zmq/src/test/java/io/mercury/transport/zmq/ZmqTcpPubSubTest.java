...
public class ZmqTcpPubSubTest {
    ...
    public void test() {
        ...
        ThreadSupport.startNewThread(() -> {
            try (ZmqSubscriber subscriber = ZmqComponent.tcp("127.0.0.1", 13001).ioThreads(1)
        ...
        try (ZmqPublisher<String> publisher = ZmqComponent.tcp("127.0.0.1", 13001).ioThreads(1)
