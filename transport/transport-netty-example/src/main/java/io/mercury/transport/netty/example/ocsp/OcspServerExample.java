...
/**
 * ATTENTION: This is an incomplete example! In order to provide a fully
 * functional end-to-end example we'd need an X.509 certificate and the matching
 * PrivateKey.
 */
...
public class OcspServerExample {
	public static void main(String[] args) throws Exception {
		...
		// Step 2: We need the URL of the CA's OCSP responder server. It's somewhere
		// encoded
