...
/**
 * Handles HTTP/2 stream frame responses. This is a useful approach if you
 * specifically want to check the main HTTP/2 response DATA/HEADERs, but in this
 * example it's used purely to see whether our request (for a specific stream
 * id) has had a final response (for that same stream id).
 */
