 ...
 * under the License.
 */
package io.mercury.transport.netty.example.stomp;
...
/**
 * very simple stomp client implementation example, requires running stomp
 * server to actually work uses default username/password and destination values
 * from hornetq message broker
 */
