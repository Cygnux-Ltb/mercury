...
public enum LegacyHanderFactory {
	...
	public static <T extends NetworkContext<T>> Function<T, TcpEventHandler<T>> legacyTcpEventHandlerFactory(
		...
		return (networkContext) -> {
			...
			@NotNull
			final Function<Object, TcpHandler<T>> consumer = o -> {
			...
			@NotNull
			final HeaderTcpHandler<T> headerTcpHandler = new HeaderTcpHandler<>(handler, consumer);

			@NotNull
			final WireTypeSniffingTcpHandler<T> wireTypeSniffingTcpHandler = new WireTypeSniffingTcpHandler<>(handler,
					(nc) -> headerTcpHandler);
