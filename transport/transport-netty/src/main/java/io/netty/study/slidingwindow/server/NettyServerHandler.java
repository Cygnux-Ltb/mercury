...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    // 滑动窗口
    private final Window<Integer, Message, Message> window = new Window<>(20);
    ...
    public void handlerResponse(Message msg) {
        int id = msg.getId();
        WindowFuture<Integer, Message, Message> future;
        try {
    ...
    public Message handlerRequest(Message request, ChannelHandlerContext ctx) {
        ...
        System.out.println("滑动窗口发送的数据:" + request);
