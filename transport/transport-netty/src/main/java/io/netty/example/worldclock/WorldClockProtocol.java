			...
			try {
				...
				while (!done) {
					...
					case 8: {
						...
						io.netty.example.worldclock.WorldClockProtocol.Continent value = io.netty.example.worldclock.WorldClockProtocol.Continent
								.valueOf(rawValue);
						if (value == null) {
	...
	public static final class Locations extends com.google.protobuf.GeneratedMessage implements LocationsOrBuilder {
				...
				while (!done) {
					...
					case 10: {
						...
						location_.add(input.readMessage(
								io.netty.example.worldclock.WorldClockProtocol.Location.PARSER,
								extensionRegistry));
						break;
					}
					}
		...
		public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
			...
			private com.google.protobuf.RepeatedFieldBuilder<io.netty.example.worldclock.WorldClockProtocol.Location, io.netty.example.worldclock.WorldClockProtocol.Location.Builder, io.netty.example.worldclock.WorldClockProtocol.LocationOrBuilder> getLocationFieldBuilder() {
				if (locationBuilder_ == null) {
					locationBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<io.netty.example.worldclock.WorldClockProtocol.Location, io.netty.example.worldclock.WorldClockProtocol.Location.Builder, io.netty.example.worldclock.WorldClockProtocol.LocationOrBuilder>(
		...
		private LocalTime(com.google.protobuf.CodedInputStream input,
			...
			try {
				...
				while (!done) {
					...
					case 40: {
						int rawValue = input.readEnum();
						io.netty.example.worldclock.WorldClockProtocol.DayOfWeek value = io.netty.example.worldclock.WorldClockProtocol.DayOfWeek
								.valueOf(rawValue);
						if (value == null) {
	...
	public static final class LocalTimes extends com.google.protobuf.GeneratedMessage implements LocalTimesOrBuilder {
				...
				while (!done) {
					...
					case 10: {
						...
						localTime_.add(input.readMessage(
								io.netty.example.worldclock.WorldClockProtocol.LocalTime.PARSER,
								extensionRegistry));
						break;
					}
					}
		...
		public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
			...
			private com.google.protobuf.RepeatedFieldBuilder<io.netty.example.worldclock.WorldClockProtocol.LocalTime, io.netty.example.worldclock.WorldClockProtocol.LocalTime.Builder, io.netty.example.worldclock.WorldClockProtocol.LocalTimeOrBuilder> getLocalTimeFieldBuilder() {
				if (localTimeBuilder_ == null) {
					localTimeBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<io.netty.example.worldclock.WorldClockProtocol.LocalTime, io.netty.example.worldclock.WorldClockProtocol.LocalTime.Builder, io.netty.example.worldclock.WorldClockProtocol.LocalTimeOrBuilder>(
