        ...
        try {
            ...
            b.group(group).channel(NioDatagramChannel.class).handler(new ChannelInitializer<DatagramChannel>() {
                ...
                protected void initChannel(DatagramChannel ch) {
                    ...
                    p.addLast(new DatagramDnsQueryEncoder()).addLast(new DatagramDnsResponseDecoder())
            ...
            DnsQuery query = new DatagramDnsQuery(null, addr, 1).setRecord(DnsSection.QUESTION,
