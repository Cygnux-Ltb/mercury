...
public final class WorldClockProtocol {
    ...
    public enum Continent implements com.google.protobuf.ProtocolMessageEnum {
        ...
        private static final EnumLiteMap<Continent> internalValueMap =
                Continent::valueOf;
        ...
        public static EnumDescriptor getDescriptor() {
            return io.netty.example.worldclock.WorldClockProtocol.getDescriptor().getEnumTypes()
                    .get(0);
        }
    ...
    public enum DayOfWeek implements com.google.protobuf.ProtocolMessageEnum {
        ...
        private static final EnumLiteMap<DayOfWeek> internalValueMap = DayOfWeek::valueOf;
    ...
    public static final class Location extends GeneratedMessage implements LocationOrBuilder {
        ...
        private Location(CodedInputStream input,
        ...
        public static com.google.protobuf.Parser<Location> PARSER = new AbstractParser<>() {
            @Override
            public Location parsePartialFrom(CodedInputStream input,
                                             ExtensionRegistryLite extensionRegistry)
                    throws InvalidProtocolBufferException {
        ...
        public static io.netty.example.worldclock.WorldClockProtocol.Location parseFrom(
                com.google.protobuf.ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static io.netty.example.worldclock.WorldClockProtocol.Location parseFrom(
                com.google.protobuf.ByteString data, ExtensionRegistryLite extensionRegistry)
                throws InvalidProtocolBufferException {
        ...
        public static Builder newBuilder(
                io.netty.example.worldclock.WorldClockProtocol.Location prototype) {
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder>
            ...
            public io.netty.example.worldclock.WorldClockProtocol.Location buildPartial() {
                io.netty.example.worldclock.WorldClockProtocol.Location result = new io.netty.example.worldclock.WorldClockProtocol.Location(
                        this);
            ...
            public Builder mergeFrom(io.netty.example.worldclock.WorldClockProtocol.Location other) {
                if (other == io.netty.example.worldclock.WorldClockProtocol.Location
                        .getDefaultInstance())
                    return this;
            ...
            public Builder mergeFrom(CodedInputStream input,
                ...
                try {
                    ...
                    parsedMessage = (io.netty.example.worldclock.WorldClockProtocol.Location) e
            ...
            public Builder setContinent(
                    io.netty.example.worldclock.WorldClockProtocol.Continent value) {
                if (value == null) {
    ...
    public static final class Locations extends GeneratedMessage implements LocationsOrBuilder {
        ...
        private Locations(CodedInputStream input,
                          ExtensionRegistryLite extensionRegistry)
                throws InvalidProtocolBufferException {
            initFields();
        ...
        public static com.google.protobuf.Parser<Locations> PARSER = new AbstractParser<>() {
            @Override
            public Locations parsePartialFrom(CodedInputStream input,
                                              ExtensionRegistryLite extensionRegistry)
                    throws InvalidProtocolBufferException {
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws IOException {
            getSerializedSize();
            for (Location location : location_) {
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (Location location : location_) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, location);
            }
            size += getUnknownFields().getSerializedSize();
            memoizedSerializedSize = size;
            return size;
        ...
        public static Builder newBuilder(
                io.netty.example.worldclock.WorldClockProtocol.Locations prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder>
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof io.netty.example.worldclock.WorldClockProtocol.Locations) {
                    return mergeFrom(
                            (io.netty.example.worldclock.WorldClockProtocol.Locations) other);
                } else {
                    super.mergeFrom(other);
                    return this;
                }
            ...
            public Builder mergeFrom(io.netty.example.worldclock.WorldClockProtocol.Locations other) {
                if (other == io.netty.example.worldclock.WorldClockProtocol.Locations
                        .getDefaultInstance())
                    return this;
                if (locationBuilder_ == null) {
                    ...
                    if (!other.location_.isEmpty()) {
                        if (locationBuilder_.isEmpty()) {
                            ...
                            location_ = other.location_;
                            bitField0_ = (bitField0_ & ~0x00000001);
                            locationBuilder_ = GeneratedMessage.alwaysUseFieldBuilders
                                    ? getLocationFieldBuilder()
                                    : null;
                        } else {
            ...
            public Builder mergeFrom(CodedInputStream input,
                ...
                try {
                    ...
                    parsedMessage = (io.netty.example.worldclock.WorldClockProtocol.Locations) e
                            .getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) {
            ...
            // repeated .io.netty.example.worldclock.Location location = 1;
            private java.util.List<io.netty.example.worldclock.WorldClockProtocol.Location> location_ = java.util.Collections
                    .emptyList();
            ...
            public Builder setLocation(int index,
                                       io.netty.example.worldclock.WorldClockProtocol.Location value) {
                if (locationBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
    ...
    public static final class LocalTime extends GeneratedMessage implements LocalTimeOrBuilder {
        ...
        private LocalTime(CodedInputStream input,
                          ExtensionRegistryLite extensionRegistry)
                throws InvalidProtocolBufferException {
            initFields();
            UnknownFieldSet.Builder unknownFields = UnknownFieldSet
        ...
        public static Parser<LocalTime> PARSER = new AbstractParser<>() {
            @Override
            public LocalTime parsePartialFrom(CodedInputStream input,
                                              ExtensionRegistryLite extensionRegistry)
                    throws InvalidProtocolBufferException {
        ...
        public static Builder newBuilder(
                io.netty.example.worldclock.WorldClockProtocol.LocalTime prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder>
            ...
            public io.netty.example.worldclock.WorldClockProtocol.LocalTime buildPartial() {
                io.netty.example.worldclock.WorldClockProtocol.LocalTime result = new io.netty.example.worldclock.WorldClockProtocol.LocalTime(
                        this);
                int from_bitField0_ = bitField0_;
                int to_bitField0_ = 0;
                if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof io.netty.example.worldclock.WorldClockProtocol.LocalTime) {
                    return mergeFrom(
                            (io.netty.example.worldclock.WorldClockProtocol.LocalTime) other);
                } else {
                    super.mergeFrom(other);
                    return this;
                }
            ...
            public Builder mergeFrom(io.netty.example.worldclock.WorldClockProtocol.LocalTime other) {
                if (other == io.netty.example.worldclock.WorldClockProtocol.LocalTime
                        .getDefaultInstance())
                    return this;
                if (other.hasYear()) {
            ...
            public Builder mergeFrom(CodedInputStream input,
                ...
                try {
                    ...
                    parsedMessage = (io.netty.example.worldclock.WorldClockProtocol.LocalTime) e
                            .getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) {
            ...
            public Builder setDayOfWeek(
                    io.netty.example.worldclock.WorldClockProtocol.DayOfWeek value) {
                if (value == null) {
                    throw new NullPointerException();
                }
                bitField0_ |= 0x00000008;
    ...
    public static final class LocalTimes extends GeneratedMessage implements LocalTimesOrBuilder {
        ...
        private LocalTimes(CodedInputStream input,
                           ExtensionRegistryLite extensionRegistry)
                throws InvalidProtocolBufferException {
            initFields();
            int mutable_bitField0_ = 0;
        ...
        public static Parser<LocalTimes> PARSER = new AbstractParser<>() {
            @Override
            public LocalTimes parsePartialFrom(CodedInputStream input,
                                               ExtensionRegistryLite extensionRegistry)
                    throws InvalidProtocolBufferException {
        ...
        public void writeTo(com.google.protobuf.CodedOutputStream output) throws IOException {
            getSerializedSize();
            for (LocalTime localTime : localTime_) {
                output.writeMessage(1, localTime);
            }
            getUnknownFields().writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            for (LocalTime localTime : localTime_) {
                size += com.google.protobuf.CodedOutputStream.computeMessageSize(1, localTime);
            }
            size += getUnknownFields().getSerializedSize();
            memoizedSerializedSize = size;
            return size;
        ...
        public static Builder newBuilder(
                io.netty.example.worldclock.WorldClockProtocol.LocalTimes prototype) {
            return newBuilder().mergeFrom(prototype);
        }
        ...
        public static final class Builder extends GeneratedMessage.Builder<Builder>
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof io.netty.example.worldclock.WorldClockProtocol.LocalTimes) {
                    return mergeFrom(
                            (io.netty.example.worldclock.WorldClockProtocol.LocalTimes) other);
                } else {
                    super.mergeFrom(other);
                    return this;
                }
            ...
            public Builder mergeFrom(
                    io.netty.example.worldclock.WorldClockProtocol.LocalTimes other) {
                if (other == io.netty.example.worldclock.WorldClockProtocol.LocalTimes
                        .getDefaultInstance())
                    return this;
                if (localTimeBuilder_ == null) {
                    ...
                    if (!other.localTime_.isEmpty()) {
                        if (localTimeBuilder_.isEmpty()) {
                            ...
                            localTime_ = other.localTime_;
                            bitField0_ = (bitField0_ & ~0x00000001);
                            localTimeBuilder_ = GeneratedMessage.alwaysUseFieldBuilders
                                    ? getLocalTimeFieldBuilder()
                                    : null;
                        } else {
            ...
            public Builder mergeFrom(CodedInputStream input,
                ...
                try {
                    ...
                    parsedMessage = (io.netty.example.worldclock.WorldClockProtocol.LocalTimes) e
                            .getUnfinishedMessage();
                    throw e;
                } finally {
                    if (parsedMessage != null) {
            ...
            // repeated .io.netty.example.worldclock.LocalTime localTime = 1;
            private java.util.List<io.netty.example.worldclock.WorldClockProtocol.LocalTime> localTime_ = java.util.Collections
                    .emptyList();
            ...
            private RepeatedFieldBuilder<io.netty.example.worldclock.WorldClockProtocol.LocalTime, io.netty.example.worldclock.WorldClockProtocol.LocalTime.Builder, io.netty.example.worldclock.WorldClockProtocol.LocalTimeOrBuilder> localTimeBuilder_;
            ...
            public Builder setLocalTime(int index,
                                        io.netty.example.worldclock.WorldClockProtocol.LocalTime value) {
                if (localTimeBuilder_ == null) {
                    if (value == null) {
                        throw new NullPointerException();
                    }
            ...
            public io.netty.example.worldclock.WorldClockProtocol.LocalTime.Builder addLocalTimeBuilder() {
                return getLocalTimeFieldBuilder()
                        .addBuilder(io.netty.example.worldclock.WorldClockProtocol.LocalTime
                                .getDefaultInstance());
            }
            ...
            public io.netty.example.worldclock.WorldClockProtocol.LocalTime.Builder addLocalTimeBuilder(
                ...
                return getLocalTimeFieldBuilder().addBuilder(index,
                        io.netty.example.worldclock.WorldClockProtocol.LocalTime
                                .getDefaultInstance());
            }
            ...
            private RepeatedFieldBuilder<io.netty.example.worldclock.WorldClockProtocol.LocalTime, io.netty.example.worldclock.WorldClockProtocol.LocalTime.Builder, io.netty.example.worldclock.WorldClockProtocol.LocalTimeOrBuilder> getLocalTimeFieldBuilder() {
                if (localTimeBuilder_ == null) {
                    localTimeBuilder_ = new RepeatedFieldBuilder<>(
    ...
    private static Descriptor internal_static_io_netty_example_worldclock_Location_descriptor;
    private static FieldAccessorTable internal_static_io_netty_example_worldclock_Location_fieldAccessorTable;
    private static Descriptor internal_static_io_netty_example_worldclock_Locations_descriptor;
    private static FieldAccessorTable internal_static_io_netty_example_worldclock_Locations_fieldAccessorTable;
    private static Descriptor internal_static_io_netty_example_worldclock_LocalTime_descriptor;
    private static FieldAccessorTable internal_static_io_netty_example_worldclock_LocalTime_fieldAccessorTable;
    private static Descriptor internal_static_io_netty_example_worldclock_LocalTimes_descriptor;
    private static FieldAccessorTable internal_static_io_netty_example_worldclock_LocalTimes_fieldAccessorTable;
        ...
        FileDescriptor.InternalDescriptorAssigner assigner = new FileDescriptor.InternalDescriptorAssigner() {
            ...
            public ExtensionRegistry assignDescriptors(
                ...
                internal_static_io_netty_example_worldclock_Location_descriptor = getDescriptor().getMessageTypes()
                        .get(0);
                internal_static_io_netty_example_worldclock_Location_fieldAccessorTable = new FieldAccessorTable(
                ...
                internal_static_io_netty_example_worldclock_Locations_descriptor = getDescriptor().getMessageTypes()
                        .get(1);
                internal_static_io_netty_example_worldclock_Locations_fieldAccessorTable = new FieldAccessorTable(
                ...
                internal_static_io_netty_example_worldclock_LocalTime_descriptor = getDescriptor().getMessageTypes()
                        .get(2);
                internal_static_io_netty_example_worldclock_LocalTime_fieldAccessorTable = new FieldAccessorTable(
                ...
                internal_static_io_netty_example_worldclock_LocalTimes_descriptor = getDescriptor().getMessageTypes()
                        .get(3);
                internal_static_io_netty_example_worldclock_LocalTimes_fieldAccessorTable = new FieldAccessorTable(
