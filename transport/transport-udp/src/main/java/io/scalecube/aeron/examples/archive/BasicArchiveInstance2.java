...
public class BasicArchiveInstance2 {

    public static final String RECORDING_EVENTS_CHANNEL_ENDPOINT = "localhost:9030";
    public static final String CONTROL_CHANNEL_ENDPOINT = "localhost:9010";
