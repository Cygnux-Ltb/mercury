...
public class MdsRecordingWithLiveDestThroughput implements AutoCloseable {
    ...
    public static final String PUBLICATION_CHANNEL = new ChannelUriStringBuilder()
            .media(UDP_MEDIA)
    ...
    public static final String RECORDING_CHANNEL = new ChannelUriStringBuilder()
            .media(UDP_MEDIA)
            .controlEndpoint(CONTROL_ENDPOINT)
            .endpoint("localhost:0")
            .build();

    public static final String LIVE_CHANNEL = new ChannelUriStringBuilder()
            .media(UDP_MEDIA)
            .controlEndpoint(CONTROL_ENDPOINT)
            .endpoint("localhost:0")
            .build();
    ...
    private void streamMessagesForRecording() throws InterruptedException {
        try (Publication publication = aeron.addExclusivePublication(PUBLICATION_CHANNEL, STREAM_ID);
            ...
            long subscriptionId = aeronArchive.startRecording(
            ...
            long recordingId = awaitRecordingStarted(countersReader, idleStrategy, publication.sessionId());
            ...
            try (AgentRunner liveAgentRunner = new AgentRunner(NoOpIdleStrategy.INSTANCE, th -> {
            }, null, new LiveAgent(subscription))) {
                liveAgentRunner.run();
            }
