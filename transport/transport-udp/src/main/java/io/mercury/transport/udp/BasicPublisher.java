 ...
 * then lingers to allow any consumers that may have experienced loss a chance
 * to NAK for and recover any missing data. The default values for number of
 * messages, channel, and stream ID are defined in {@link SampleConfiguration}
 * and can be overridden by setting their corresponding properties via the
 * command-line; e.g.: -Daeron.sample.channel=aeron:udp?endpoint=localhost:5555
 * -Daeron.sample.streamId=20
 */
public class BasicPublisher {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        // If configured to do so, create an embedded media driver within this
        // application rather
