...
/**
 * Receives files in chunks and saves them in a directory provided as the first
 * command line option or the temporary directory if no command line arguments
 * are provided.
 * <p>
 * Protocol is to receive a {@code file-create} followed by 1 or more
...
public class FileReceiver {
	...
	private void fileChunk(final long correlationId, final long chunkOffset, final long chunkLength,
