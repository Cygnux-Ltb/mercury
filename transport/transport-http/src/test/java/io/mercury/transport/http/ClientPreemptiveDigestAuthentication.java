...
/**
 * An example of how HttpClient can authenticate multiple requests using the
 * same Digest scheme. After the initial request / response exchange all
 * subsequent requests sharing the same execution context can re-use the last
 * Digest nonce value to authenticate with the server.
 */
