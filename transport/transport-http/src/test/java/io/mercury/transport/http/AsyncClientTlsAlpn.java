...
/**
 * This example demonstrates how to avoid the illegal reflective access
 * operation warning when running with Oracle JRE 9 or newer.
 */
public class AsyncClientTlsAlpn {
	...
	public final static void main(final String[] args) throws Exception {
		...
		try (final CloseableHttpAsyncClient client = HttpAsyncClients.custom()
			...
			final SimpleHttpRequest request = SimpleRequestBuilder.get().setHttpHost(target).setPath("/httpbin/")
					.build();
