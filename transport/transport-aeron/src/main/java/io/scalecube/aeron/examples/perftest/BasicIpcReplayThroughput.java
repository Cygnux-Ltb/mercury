...
public class BasicIpcReplayThroughput implements AutoCloseable {
    ...
    public static void main(final String[] args) {
        try (BasicIpcReplayThroughput test = new BasicIpcReplayThroughput()) {
    ...
    void onMessage(final DirectBuffer buffer, final int offset,
