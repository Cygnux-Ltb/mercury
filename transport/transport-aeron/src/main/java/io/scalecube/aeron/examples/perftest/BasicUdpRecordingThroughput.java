...
public class BasicUdpRecordingThroughput implements AutoCloseable {
    ...
    public static void main(final String[] args) {
        try (BasicUdpRecordingThroughput test = new BasicUdpRecordingThroughput()) {
    ...
    private void streamMessagesForRecording() {
        try (ExclusivePublication publication = aeron.addExclusivePublication(RECORDING_CHANNEL, STREAM_ID)) {

            aeronArchive.startRecording(ChannelUri.addSessionId(RECORDING_CHANNEL, publication.sessionId()),
                    STREAM_ID,
