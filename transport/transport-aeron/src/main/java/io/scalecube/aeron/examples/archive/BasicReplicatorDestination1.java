...
public class BasicReplicatorDestination1 {

    public static final String RECORDING_EVENTS_CHANNEL_ENDPOINT = "localhost:11030";
    public static final String CONTROL_CHANNEL_ENDPOINT = "localhost:11010";
