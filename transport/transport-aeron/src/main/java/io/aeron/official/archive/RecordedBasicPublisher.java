 ...
 * publisher sends a fixed number of messages on a channel and stream ID.
 * <p>
 * The default values for number of messages, channel, and stream ID are defined
 * in {@link SampleConfiguration} and can be overridden by setting their
 * corresponding properties via the command-line; e.g.:
