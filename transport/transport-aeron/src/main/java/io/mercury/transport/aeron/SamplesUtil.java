...
public class SamplesUtil {
     ...
     * {@link IdleStrategy} when no messages are received.
     *
     * @param fragmentHandler to be called back for each message.
     * @param limit           passed to
     *                        {@link Subscription#poll(FragmentHandler, int)}.
    ...
    /**
     * Return a reusable, parametrised event loop that calls and idler when no
    ...
    /**
     * Return a reusable, parametrised {@link FragmentHandler} that prints to
     * stdout.
     *
