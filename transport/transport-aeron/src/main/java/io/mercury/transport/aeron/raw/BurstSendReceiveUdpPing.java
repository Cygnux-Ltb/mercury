...
public class BurstSendReceiveUdpPing {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        while (running.get()) {
            measureRoundTrip(histogram, sendAddress, buffer, packetSize, burstSize, receiveChannel, sendChannel,
                    running);
    ...
    private static void measureRoundTrip(final Histogram histogram, final InetSocketAddress sendAddress,
                                         final ByteBuffer buffer, final int packetSize, final int burstSize, final DatagramChannel receiveChannel,
                                         final DatagramChannel sendChannel, final AtomicBoolean running) throws IOException {
