...
/**
 * Publisher that sends a given number of messages at a given length as fast as
 * possible.
 */
public class StreamingPublisher {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        try (Aeron aeron = Aeron.connect(context); Publication publication = aeron.addPublication(CHANNEL, STREAM_ID)) {
            ...
            do {
                ...
                System.out.format("%nStreaming %,d messages of%s size %d bytes to %s on stream id %d%n",
