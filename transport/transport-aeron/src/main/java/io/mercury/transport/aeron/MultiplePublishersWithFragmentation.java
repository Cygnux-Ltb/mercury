 ...
 * messages to a channel and two different stream IDs. The default STREAM_ID and
 * CHANNEL are configured in {@link SampleConfiguration}.
 * <p>
 * The default channel and stream IDs can be changed by setting Java system
 * properties at the command line, e.g.:
