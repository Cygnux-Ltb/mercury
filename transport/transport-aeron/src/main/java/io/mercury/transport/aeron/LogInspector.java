...
import static io.aeron.logbuffer.LogBufferDescriptor.defaultFrameHeader;
import static io.aeron.logbuffer.LogBufferDescriptor.endOfStreamPosition;
import static io.aeron.logbuffer.LogBufferDescriptor.indexByTermCount;
...
/**
 * Command line utility for inspecting a log buffer to see what terms and
...
public class LogInspector {
    ...
    public static final String AERON_LOG_DATA_FORMAT = System.getProperty(AERON_LOG_DATA_FORMAT_PROP_NAME, "hex")
            .toLowerCase();
    ...
    public static final boolean AERON_LOG_SKIP_DEFAULT_HEADER = Boolean
    ...
    public static void main(final String[] args) {
        ...
        try (LogBuffers logBuffers = new LogBuffers(logFileName)) {
            ...
            for (int i = 0; i < PARTITION_COUNT; i++) {
                ...
                out.format("Index %d Term Meta Data termOffset=%d termId=%d rawTail=%d position=%d%n", i, termOffset,
                        termId, rawTail,
