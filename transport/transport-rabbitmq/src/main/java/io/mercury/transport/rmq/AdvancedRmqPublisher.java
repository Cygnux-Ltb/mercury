...
public class AdvancedRmqPublisher<T> extends RmqTransport implements Publisher<String, T>, Sender<T> {
	 ...
	 * @return
	 */
	public static AdvancedRmqPublisher<byte[]> createWithBytes(@Nullable String tag, @Nonnull RmqPublisherConfig config,
			@Nullable AckCallback ackCallback, @Nullable NoAckCallback noAckCallback) {
