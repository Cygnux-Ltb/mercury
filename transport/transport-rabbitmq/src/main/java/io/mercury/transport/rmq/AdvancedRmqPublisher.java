 ...
 */
@ThreadSafe
public class AdvancedRmqPublisher<T> extends RmqTransport
        implements Publisher<String, T>, Sender<T> {
     ...
     * @return
     */
    public static <T> AdvancedRmqPublisher<T> create(
            @Nonnull RmqPublisherConfig config,
            @Nonnull BytesSerializer<T> serializer) {
        return new AdvancedRmqPublisher<>(null, config, serializer,
                null, null);
    }
     ...
     */
    public static <T> AdvancedRmqPublisher<T> create(
            @Nullable String tag, @Nonnull RmqPublisherConfig config,
            @Nonnull BytesSerializer<T> serializer) {
        return new AdvancedRmqPublisher<>(tag, config, serializer,
                null, null);
    }
     ...
     * @return
     */
    public static AdvancedRmqPublisher<String> createWithString(
            @Nullable String tag, @Nonnull RmqPublisherConfig config,
            @Nonnull Charset charset) {
    ...
    public static AdvancedRmqPublisher<String> createWithString(
            @Nullable String tag, @Nonnull RmqPublisherConfig config,
            @Nonnull Charset charset, @Nullable AckCallback ackCallback,
            @Nullable NoAckCallback noAckCallback) {
    ...
    @Override
    public void publish(@Nonnull String target, @Nonnull T msg)
